...
def test_dipeom4_cl2():
    ...
    #R, omega, r0 = run_eomcc_calc(R, omega_guess, T, H1, H2, o, v, method="dipeom3", state_index=[1])
    #for i in range(len(R)):
    #    delta_star = run_dip_correction(T, R[i], omega[i], fock, g, H1, H2, o, v, method="dipeom4_star")
