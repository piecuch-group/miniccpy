...
def test_eomrccsdt_chplus():
    ...
    R, omega, r0 = run_eomcc_calc(R0, omega0, T, H1, H2, o, v, method='eomrccsdt', state_index=[0, 2, 3], maxit=200, max_size=30)
