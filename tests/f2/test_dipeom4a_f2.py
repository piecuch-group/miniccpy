...
def test_dipeom4a_f2():
    ...
    fock, g, e_hf, o, v, orbsym = run_scf(geom, basis, nfrozen, unit="Bohr", symmetry="D2H", cartesian=True, charge=-2, return_orbsym=True)
    ...
    r3_excitations = get_active_4h2p_pspace(no, nu, nacto=2, orbsym=orbsym, point_group="D2H", target_irrep="B1G")
    ...
    r3_excitations = get_active_4h2p_pspace(no, nu, nacto=2, orbsym=orbsym, point_group="D2H", target_irrep="AU")
    ...
    # Check the results
    #
    expected_vee = [-0.146443421684, -0.146427327877]
