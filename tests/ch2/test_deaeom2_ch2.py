...
R, omega_guess = run_guess(H1, H2, o, v, 5, method="deacis", mult=1, nactu=T[0].shape[0])
R, omega, r0 = run_eomcc_calc(R, omega_guess, T, H1, H2, o, v, method="deaeom2", state_index=[0, 1, 2])
