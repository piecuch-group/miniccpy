...
from miniccpy.pspace import get_active_4h2p_pspace, get_active_4h2p_pspace_array
...
R_a1, e_a1, r0 = run_eomcc_calc(R, omega_guess, T, H1, H2, o, v, method="dipeom4_p", state_index=[0, 3], r3_excitations=r3_excitations)
