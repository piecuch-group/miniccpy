...
R, omega_guess = run_guess(H1, H2, o, v, 10, method="cisd", mult=1, nacto=3, nactu=3)
R, omega, r0 = run_eomcc_calc(R, omega_guess, T, H1, H2, o, v, method="eomcc3", state_index=[1, 2], fock=fock, g=g)
