...
# Check the results
#
assert np.allclose(E_corr, -0.178932834216145, atol=1e-9)
assert np.allclose(omega[0], 0.106436680731, atol=1e-9)
assert np.allclose(omega[1], 0.100838711471, atol=1e-9)
