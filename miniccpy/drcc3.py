...
def compute_t3(t1, t2, e_abcijk, f, g, o, v):
    ...
    I_vvov = H2[v, v, o, v] +np.einsum("me,abim->abie", H1[o, v], t2, optimize=True)

    triples_res = -0.25 * np.einsum("amij,bcmk->abcijk", H2[v, o, o, o], t2, optimize=True)
...
def kernel(fock, g, o, v, maxit, convergence, energy_shift, diis_size, n_start_diis, out_of_core, use_quasi):
    ...
    print("    ==> Dressed CC3 amplitude equations <==")
    print("")
    ...
    for idx in range(maxit):
        ...
        raise ValueError("Dressed CC3 iterations did not converge")
