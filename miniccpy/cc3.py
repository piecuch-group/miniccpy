...
def doubles_residual(t1, t2, f, g, o, v, X_vooo, X_vvov, e_abc):
    ...
    # Parts contracted with T3
    X_ooov = g[o, o, o, v] + H2[o, o, o, v]
    X_vovv = g[v, o, v, v] + H2[v, o, v, v]
    for i in range(no):
        for j in range(i + 1, no):
            for k in range(j + 1, no):
                # fock denominator for occupied
                ...
                doubles_res[:, :, i, j] += 0.5 * np.einsum("e,abe->ab", H1[o, v][k, :], t3_abc, optimize=True) # (1)
