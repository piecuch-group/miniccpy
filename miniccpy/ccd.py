import time
import numpy as np
from miniccpy.energy import cc_energy_doubles, hf_energy, hf_energy_from_fock
...
def kernel(fock, g, o, v, maxit, convergence, energy_shift, diis_size, n_start_diis, out_of_core, use_quasi):
    ...
    old_energy = cc_energy_doubles(t2, g, o, v)
    ...
    for idx in range(maxit):
        ...
        current_energy = cc_energy_doubles(t2, g, o, v)
    ...
    diis_engine.cleanup()
    e_corr = cc_energy_doubles(t2, g, o, v)
